...
## 8. Checklist
- [ ] Read every [review] commit and every watched-path diff
- [ ] Dependency changes accepted (or none)
- [ ] Panel pin decision recorded (keep / bump via make panel-bump)
- [ ] Models snapshot decision recorded (keep / make refresh-models)
- [ ] New raw transport sites guarded and allowlisted (or none)
